        ...
        <>
            <div className="container">
                ...
                <div className="living-section">
                    ...
                    <p className="home_weight_second">Sort by</p>
                    </div>
                        
                        <div className="img-left-section">
                        
                        <img src={require('../../assest/img/filter-img/living-first-img.png')} className="living-img" alt="#" />
                        <img src={require('../../assest/img/filter-img/living-second-img.png')} className="living-img" alt="#" />
